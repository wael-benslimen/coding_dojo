...
import com.joybundel.demo.models.LoginTemplate;
import com.joybundel.demo.models.User;
import com.joybundel.demo.repositories.UserRepository;
...
public class UserService {
	...
	public User login(LoginTemplate newLogin,BindingResult result) {
		...
		if(getByEmail(newLogin.getEmail()) == null) {
			result.rejectValue("email","uniqueness","Email dos not exists");
		}

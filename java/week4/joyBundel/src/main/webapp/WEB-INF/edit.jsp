...
<html>
    ...
    <body>
        ...
        <form:form modelAttribute="baby" action="/names/${baby.id }/edit" method="POST" class="col-8">
            <div class="form-group">
                <form:label path="name">enter name</form:label>
                <form:input path="name" type="text" placeholder="enter name" class="form-control" readonly="true" />
        ...
        <a href="/names/delete/${baby.id}" class="btn btn-danger mt-5">delete</a>
        </div>
    </body>
